...
export class LivePoller {
  ...
  _setupPollChannel() {
    ...
    pollChannel.on("new_vote", vote => {
      ...
      console.log("Got message for ", vote.entry_id)
    ...
    pollChannel
      .join()
      .receive("ok", resp => { console.log("Joined", pollId) })
  ...
  _updateDisplay(entryId) {
    ...
    console.log("Searching for the correct entry")
  ...
  _setupVoteButtons(pollChannel) {
    ...
    $(".vote").on("click", event => {
      ...
      console.log("Publishing vote for: ", entryId)
